...
Les enseignants soulignent que Mentimeter est facile d’accès et relativement fluide. La version gratuite est suffisante pour préparer des sondages avec différents types de questions. Ils suggèrent, lors de l’affichage des questions aux étudiant-es de répondre soi-même (y compris avec des réponses fausses), car ils ont observé un effet de groupe lors de ces activités : quelques réponses affichées vont favoriser la participation générale.
Les enseignants ont également testé SpeakUp, une plateforme permettant aux étudiant-es de poser leurs propres questions sur le cours. Cependant, sous couvert de l’anonymat, certains étudiant-es ont profité de l’outil pour lancer des discussions informelles et parfois déviantes. Face à cette problématique, les enseignants utilisent désormais cette plateforme en l’intégrant sur Moodle afin que les contributions étudiantes soient nominatives. Par un système de « like » similaire à celui d’un réseau social, la plateforme permet de savoir très rapidement quelles sont les questions étudiantes les plus pertinentes pour l’ensemble du groupe.
