...
- [Ebook interactif](http://r.smac-group.com/) *(lien externe indisponible)*
- [Support de cours et exercices avec correction interactive](http://intro-to-ds.netlify.com/) *(lien externe indisponible)*
- [Exemple d'exercices avec correction](https://www.unige.ch/innovations-pedagogiques/download_file/593/446)
- [Plateforme de travail Piazza](https://piazza.com/)
- [Exemple de discussions sur Piazza](https://www.unige.ch/innovations-pedagogiques/download_file/594/446)
- [Exemple d'application Web développée par l'enseignant](https://dal-unige.shinyapps.io/rmd_app/)
- [Syllabus du cours de Doctorat](https://www.unige.ch/innovations-pedagogiques/download_file/597/446)
