...
Le 1er module est introduit par un cours ex cathedra. Ensuite, pour chacun des modules, les étudiant-es ont accès en ligne, à partir de la plateforme Moodle, à une série de courtes vidéos (&sim; 5 min) réalisées par des assistant-es et des étudiant-es dans le cadre d’un stage académique, sous la supervision de l’enseignante. Le cours et les vidéos forment la base théorique du cours.
...
- [Exemples de vidéos pédagogiques (réservé aux membres de l'UNIGE)](https://mediaserver.unige.ch/play/VN3-1466-2017-2018-A) *(lien externe indisponible)*
