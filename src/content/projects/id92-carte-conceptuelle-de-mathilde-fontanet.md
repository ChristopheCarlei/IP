...
L’enseignante attire l’attention sur le fait qu’il faut vérifier que les participant-es sont en capacité de mener à bien la tâche. Il est également important d’indiquer aux étudiant-es que de bonnes capacités en dessin ne sont pas nécessaires et si besoin les rassurer. Il est également toujours bienvenu de rappeler quelques règles avant les échanges au sein des binômes (pas de jugement de valeur et respect mutuel).
Notons encore que la carte conceptuelle est un outil dont l’apprentissage pourra se révéler utile lors de la rédaction des mémoires pour les étudiant-es. Elle peut permettre de représenter parfois tout un domaine, la structure d’un texte ou tout simplement son contenu. La personne qui dresse la carte crée sa propre structure, établit la logique dans ce qu’elle voit.
