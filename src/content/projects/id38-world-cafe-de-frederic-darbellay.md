...
description_short: "Afin de concevoir une école \"amie des enfants\", les étudiant-es participent à un world café pédagogique proposant un jeu de rôle dans lequel les étudiant-es travaillent en équipes sur une thématique commune, chacunes ayant un rôle spécifique."
featured: false
status: actif
---
...
Laisser la liberté de choix de format pour la présentation orale permet à certain-es étudiant-es d’être très créatif/ves, ils/elles peuvent même développer de nouvelles idées de forme d’enseignement pour les prochaines éditions du cours. Une année, les étudiant-es ont ainsi pris le parti de créer une journée de forums pour présenter leurs travaux de groupes. Les enseignant-es étaient ainsi invité-es à prendre part à cette journée en se rendant de stand en stand sur chacun desquels les étudiant-es présentaient par groupe leurs travaux sous forme de posters, animations, présentations, etc.

## Avis des étudiant·es

> « De ne pas faire un cours traditionnel et nous permettre ainsi de voir autre chose. Ce n’est pas fréquent dans le monde académique malheureusement et ça devrait l’être, car le cours était très stimulant. »
> « J’ai beaucoup aimé le World café qui m’a permis de partager les différents points de vue concernant l’éducation à l’école aujourd’hui et qui a beaucoup aidé dans la réalisation du rapport. »
> « Varier les formes d’enseignement est un plus. »
