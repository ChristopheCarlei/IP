...
description_short: "L'enseignante utilise des extraits de films ethnographiques, sociologiques et documentaires pour présenter la théorie. Les étudiant-es sont ensuite invité-es à réaliser un film documentaire individuellement ou en groupe, en choisissant leur méthodologie et leur thématique."
featured: false
status: actif
---
...
La modélisation et l’animation 3D ont été spécifiquement appliquées dans ce cours à la médecine dentaire. La démarche pédagogique pouvant tout à fait être élargie à n’importe quel cours d’anatomie et plus largement à d’autres disciplines.
Pour ce transfert, la partie la plus longue et laborieuse est la création et l’animation du contenu 3D. Il convient ensuite de pouvoir faire son cours dans une salle équipée de vidéoprojecteurs (ou écrans) 3D et de lunettes 3D. Sinon l’alternative serait l’utilisation de visionneuses de réalité virtuelle (Google Cardboard ou autre alternative non coûteuse) en combinaison avec des smartphones si disponibles.
...
> Le succès a été fulgurant dès le début du projet. Les étudiant-es ont été instantanément captivé-es par cette nouveauté, et leur attention soutenue tout au long du cours.
> Le succès suivant fut constaté lors des travaux pratiques lors desquels les étudiant-es doivent sculpter une dent dans de la cire. La majorité des superviseurs a eu l’impression que les étudiant-es de cette année ont fait un très bon travail.
