...
description_short: "Dans ce cours, l'enseignant sollicite régulièrement les étudiant-es à travers des questionnaires de satisfaction pour s'assurer de l'intérêt et de la pertinence du contenu. Cela lui permet d'adapter le cours en fonction des commentaires reçus et d'améliorer l'expérience d'apprentissage."
featured: false
status: actif
---
...
L’enseignant souligne que ce format de questionnaire est très utile pour un cours avec peu d’étudiant-es ne pouvant bénéficier des évaluations institutionnelles. Il permet d’avoir un accès direct aux commentaires des étudiant-es après chaque cours et de se recentrer ou préciser certains points lors des cours suivants en fonction des retours obtenus.
