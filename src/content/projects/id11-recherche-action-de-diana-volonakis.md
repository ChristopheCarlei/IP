...
Le modèle pédagogique employé est flexible et présente un haut potentiel de transfert. Les partenaires extra-académiques sollicité-es dans le cadre du module peuvent varier. Il peut se déployer dans une temporalité semestrielle ou annuelle. Le service rendu à la communauté peut être direct ou indirect, et peut s’appliquer à des entités plus ou moins larges (ex., le campus, la municipalité, l’État, un cyberespace donné).
