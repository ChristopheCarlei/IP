...
description_short: "Dans ce cours, les étudiant-es choisissent un article scientifique utilisant une méthodologie spécifique, puis le répliquent en refaisant les analyses statistiques. Les présentations orales des réplications constituent l'évaluation principale du cours, avec des groupes remaniés à chaque cycle de 3 semaines."
featured: false
status: actif
---
...
Ce format d’enseignement permet aux étudiant-es d’acquérir des compétences génériques en travail d’équipe et présentation orale. La formation des groupes par l’enseignant évite le regroupement des étudiant-es par affinité ou par niveau de compétence. Le remaniement régulier de ceux-ci renforce l’hétérogénéité des niveaux de compétences au sein des groupes.
