...
- [Grille d’évaluation](https://edutechwiki.unige.ch/fr/STIC:STIC_I_(Baldur)#Grille_d'%C3%A9valuation)
- [Pensée computationnelle avec JavaScript](https://edutechwiki.unige.ch/fr/Initiation_%C3%A0_la_pens%C3%A9e_computationnelle_avec_JavaScript)
- [Exemple d’un projet à concevoir](http://edutechwiki.unige.ch/fr/STIC:STIC_I_-_exercice_3_(Aegir))
- [Exemple d'un diaporama interactif](http://mafritz.ch/slides/fr/glisser-deposer/#/)
- [Exemple d’une application interactive](http://tecfa.unige.ch/perso/mafritz/teaching/stic-1/apps/number-sorting-game/)
- [Exemple de e-portfolio d’étudiante (accès libre sur le web) : Emilie Lettry](http://tecfaetu.unige.ch/etu-maltt/yoshi/lettry0/)
- [Exemple de e-portfolio d’étudiant (accès libre sur le web) : Didier Dorsaz](http://tecfaetu.unige.ch/etu-maltt/zelda/dorsazd9/)
- [Exemple de e-portfolio d’étudiant (accès libre sur le web) : Thomas W&uuml;nsche](http://tecfaetu.unige.ch/etu-maltt/aegir/wunscht0/)
