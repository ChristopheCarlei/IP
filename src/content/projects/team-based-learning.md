...
- [Les 7 choses que vous devriez savoir sur … le team-based learning (TBL)](https://ciel.unige.ch/2019/04/les-7-choses-que-vous-devriez-savoir-sur-le-team-based-learning-tbl/)
- [Plugin Group quiz](https://moodle.org/plugins/quiz_group)
- [Espace Moodle pour démonstration de l’usage du format d’enseignement TBL](http://moodle.unige.ch/enrol/index.php?id=6816)
