...
The teacher mentions that Votamatic has advantages and disadvantages. The main advantages are that it is easy to use and quick to set up. The main disadvantage is that the presentation of the results does not highlight the correct answer. Indeed, the statistics of the answers show the most chosen answer or answers, but no mention is made of the correct answer.

The teacher takes care to ensure that the Votamatic she proposes reassures the students, showing them that they have understood the essential concepts. It is important for her not to ask questions that are too complex, which could discourage them. She therefore targets the questions on the key notions and avoids dwelling on simple details.

It is also important, according to the teacher, to know how to limit the number of tools used so as not to devote too much time to them, either in terms of preparation or class time dedicated to these tools. For example, she explains that she does not use Votamatic in her Master's courses, where direct interaction is facilitated by the small number of students.

## Student feedback

> "The course is well structured and the slides are clear. The exercises on Moodle make it easy to understand the course. The Votamatic's help to see how well one has understood the course."
> "Thank you for this course that connects theory and practice well. The exercises and Votamatic are good ways to work through the course."
> "The surveys are great, they give you an idea of what you're going to talk about beforehand, and a little review after class."
