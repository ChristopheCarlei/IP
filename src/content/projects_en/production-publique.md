...
The teacher emphasizes that for such a teaching format, it is important to give students a precise framework. It is important to be particularly clear about the expected work and the tools to carry it out. It follows that this format is time-consuming in terms of feedback (particularly for the re-reading of the files), but also in order to schedule meetings with the various external collaborators, the final presentation session and the visits. It is therefore important to ensure that the sessions are well structured.

For the students, the teamwork and the possibility of putting theoretical knowledge into practice within a concrete project are very stimulating. The results are noticeable and rewarding.

Student feedback

"This course allows us to develop a solid foundation to better approach our research. The visits to the various libraries in Geneva and to the theater are very interesting."

"The library visits, the assignments to be handed in (file, bibliography) that train us well in musicological research."

"Meeting with different actors of the cultural life of Geneva (musical resources of the Grand Théâtre, director of the Offenbach opera, etc.). Discoveries of the different Geneva institutions related to musicology."
