...
Allowing students to exchange and get to know each other during the 1er course facilitates further exchanges. The teaching format requires that several elements be taken into account, as the teacher points out. For example, it is necessary to take into account that some students only arrive at the 2e session or do not start preparing right away. In this case, it is necessary to propose a first team work that does not involve a fundamental notion and to propose to the students who have not prepared to take the status of guests. Care should be taken to organize the work so that those who have prepared can benefit most from the discussion, introducing questions about the degree of preparation into the critical reflection. Cooperative elements should be added as the sessions progress. Alternative arrangements should also be made for absences.

## Student feedback

> The main strengths of the course identified by the students are the alternation of theoretical and practical parts, the use of cooperative learning within the course itself and the group work.
> " [The strengths of the course are:] Experiencing the method of working that you learn by using it during the course."
> " [The strengths of the course are:] The complementarity of theory and practice: we live what we read. The flexibility of the teaching that allows us to take the time we need while staying on track."
> “[The strengths of the course are:] The regular required readings + The small group and then whole class discussions with feedback from the teacher."
