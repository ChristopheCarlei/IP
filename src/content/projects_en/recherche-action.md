...
The pedagogical model used is flexible and has a high potential for transferability. The extra-academic partners involved in the module can vary. It can be deployed on a semester or yearly basis. The service to the community can be direct or indirect and can be applied to larger or smaller entities (e.g., the campus, the municipality, the state, a given cyberspace).
