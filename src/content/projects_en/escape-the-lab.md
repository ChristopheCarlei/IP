...
images:
  ...
  - /images/gallery/proj-55-3.jpg
  - /images/gallery/proj-55-4.png
  - /images/gallery/proj-55-5.png
---
...
For example, this division is behind the InfoTrack platform. By adapting the content of InfoTrack to a face-to-face version, the team created a board game called "the race for the quote". After the presentation of a few InfoTrack videos to the class, the class is then invited to play the board game that forms the body of the course.
...
The benefits of using games in higher education are widely recognized in the literature. It is an active teaching method that breaks with the usual practices of university pedagogy.

With the use of a board game such as Escape the Lab, the trainer steps aside and lets the learners be the focus of their learning. The trainer becomes a facilitator who answers questions while letting the players interact with each other. The game thus promotes peer learning.

Finally, even if players do not go through all the questions in a game, the game mechanism and the voluntary overlapping of certain questions ensure that the majority of important concepts have been covered by the learners. In addition, the "bonus" cards break the monotony that could occur if all the questions followed the same pattern.

To add an extra element of gamification and encourage participants to immerse themselves in the game, if several groups are playing in parallel, a small prize can be promised to theère team that escapes from the lab.

The "Escape the Lab" game files are available for download on GitHub under the Creative Commons CC BY license and can therefore be freely reused or adapted at other institutions.

Moreover, the game makes it relatively easy to create versions adapted to slightly different training situations, for example on a related topic (such as scientific publishing in general or open research data) or for a more novice audience.
