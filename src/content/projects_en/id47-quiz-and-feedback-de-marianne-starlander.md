...
The great advantage of quizzes on Moodle is that they are automatically corrected. This saves time for the teacher (who still has to check all the corrections), but also for the students who have direct feedback on their performance in the quiz.
Workshops offered by the Pôle SEA allow to see how UNIGE teachers use quizzes on Moodle, and give advice on the formulation of questions and answer options. Implementing a quiz for the exam requires contacting the university's dedicated service to validate it and apply the necessary parameters.
The use of peer assessment also allows students to get quicker feedback, but also richer as three peers evaluate and comment on each student's work. This format encourages students to be more engaged in learning, as they have to step back and look at what others have done. A different answer from their own is not necessarily wrong, and it opens up their knowledge.

## Student feedback

> "The practical work and quizzes help to better assimilate the material."
> "The topics covered and the exercises to be done at home (quizzes, lab work) allow students to become familiar with documentary research, especially on the internet."
