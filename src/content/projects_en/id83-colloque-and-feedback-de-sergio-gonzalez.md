...
The teacher emphasized that this questionnaire format is very useful for a course with few students who cannot benefit from institutional evaluations. It allows for direct access to student comments after each course and for refocusing or clarifying certain points during subsequent courses based on the feedback received.
