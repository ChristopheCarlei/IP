...
Teachers note that Mentimeter is easy to access and relatively smooth. The free version is sufficient to prepare surveys with different types of questions. They suggest, when posting the questions to the students, that they answer them themselves (even with wrong answers), because they have observed a group effect during these activities: a few posted answers will encourage general participation.
The teachers also tested SpeakUp, a platform allowing students to ask their own questions about the course. However, under the cover of anonymity, some students took advantage of the tool to launch informal and sometimes deviant discussions. Faced with this problem, the teachers now use this platform by integrating it into Moodle so that student contributions are nominative. Through a "like" system similar to that of a social network, the platform makes it possible to know very quickly which student questions are the most relevant for the whole group.
