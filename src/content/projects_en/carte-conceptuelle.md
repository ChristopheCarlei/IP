...
The teacher draws attention to the fact that it is necessary to verify that the participants are able to carry out the task. It is also important to point out to the students that good drawing skills are not necessary and if necessary to reassure them. It is also always a good idea to remind the students of a few rules before the exchanges within the pairs (no value judgments and mutual respect).

Let us also note that the conceptual map is a tool that can be useful to students when writing their dissertations. It can be used to represent a whole field, the structure of a text or simply its content. The person who draws the map creates his or her own structure, establishing logic in what he or she sees.
