...
The teacher draws attention to the choice of methods. She realized that students are somewhat reluctant to explore new methods. However, once they do, students take ownership and use the new methods very well. During this semester's course (2020), teachers have asked students to produce a poster at the end of the course to present their research report. The posters will be published on the NCCR LIVES website.

## Student feedback

> "Interactive and participatory side, significant student solicitation and consideration."
> “Press Review: "Having to write a report on current articles allows students to be aware of the hot news on the topic."
> “Jigsaw Class and Innovative Research Methods: "The alternative methods proposed for group work are very interesting and allow us to discover new qualitative approaches (such as material culture or migration maps)."
