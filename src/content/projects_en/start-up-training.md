...
The originality of this program is that it is not taught by one teacher, but by a team of practitioners and professionals in the field of entrepreneurship. The program is very sensitive to student feedback, which is collected after each session. All these feedbacks allow the facilitators to question themselves and to adapt their interventions accordingly to improve the program from year to year.

The preparation of the different sessions of the program requires important logistics beforehand to organize each session according to the availability of the different speakers, mentors, and coaches.

To prepare the participants for certain sessions, they are provided with video clips. These videos required a lot of time and money, but they are now valuable resources to use in flipped classroom.

One of the main values of this program is that people with very different backgrounds and situations can work together on the same project. The same team can be made up of a bachelor’s level student in biology, another Master's level student in computer science, a doctoral student in psychology and a professor in physics, for example. This heterogeneity of profiles and this intergenerational constitution of the groups can be very favorable for the progress of the projects.

It was important for the teacher to create a climate of trust with the students and to break the ice at the beginning of the course, especially for a fully distance learning course and for Bachelor students. She wanted to show her empathy for the students facing the difficult situation of studying during the year 2020. She herself did not hesitate to share her own feelings about the situation and to regularly check on their condition.

She observed that the online format had the advantage of sometimes freeing up speech and helped the shyest students to participate more easily. However, the mobilization of students in the breakout rooms on Zoom was not always possible because of the material conditions of work for some students (living in a shared apartment, studying in the library, etc.).

The teacher recommends not to undervalue the time that such a program requires to set up. It takes a lot of time to shoot video and edit it. It often takes several trials. It is also necessary to prepare the questions that are part of the course in advance and test them with the course assistants. Then you have to think about the planning of the course and the pedagogical coherence. Offering students so many alternative activities to animate the course and deliver the course content requires a great deal of commitment from the teaching team, both for the preparation and for the follow-up of activities and support throughout the year.

## Student feedback

> "An amazing opportunity to get expert professional training and to be part of the process of developing a business idea from the start!"
> "The Business Concept training program did cover all areas of entrepreneurship in a great way. Mentors have good critics and are very knowledgeable! I would recommend anyone willing to make a start-up to follow the course! “
> "This course gave me the chance to learn from high level lecturer and great mentors. This is a real push to my motivation to create my own start-up."
> "I am very thankful to all the trainers. I am a researcher in material science and novice in business but the trainings provide me a good insight of connecting the research and development to business. To start a business or market a product, as a scientist we should not be worried to much. even a simple useful innovation can make us rich. We need to figure out what do people need and pay for it. “
> "Great course and introduction to entrepreneurship, especially for people of engineering background. It provides a good overview of all relevant topics such as market analysis, accounting, financial planning, team work, search for funding and presentation skills."
> "I highly recommend to follow this course, it brings every thing you need to know about entrepreneurship! Of course, if you really want to build a strong start-up, you will need to work a lot more than just the home-works for the course, but we now have everything in hand to go further. I had a lot of pleasure to work with my team-partner, and every encounter with our mentors was really interesting. They helped us really greatly, always with much sympathy. "
> "This comprehensive course offers a 360° view of what it takes to found a start up. You leave with a complete bag of tools to found your own business. Thank you for the great experience!"

> ID 99 - Online courses & interactivity by Bettina Palazzo [11/21]
