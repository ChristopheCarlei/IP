...
A course in interactive format may lead to deviations from the content originally planned. It is possible, for example, that a clarifying question will lead to earlier and more in-depth coverage of the content. If the idea is to see what the students have understood and to conduct the course from there, it is to be expected that the course will not necessarily proceed as planned. As a result, this requires some flexibility on the part of the teacher.

On the other hand, it is necessary to be attentive during the moments when students speak: some students who are more at ease respond more spontaneously and more frequently than others. It is therefore important to allow everyone to prepare to speak thanks to discussions between students and to invite those who would not speak spontaneously to do so.

## Student feedback

> "The moments of sharing with peers are necessary for learning, because they sometimes allow us to readjust our vision of things. The fact that the teacher is very present during these moments is also essential, because we can more easily ask her questions about understanding, among other things. In general, the interactive aspect of the course is a strong point."
