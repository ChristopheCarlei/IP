...
In general, this teaching format allows students to be active during the practical work, to be involved (creation of questions and setting up of plants) and to have a more global vision of the subject. The teaching team has put in place a dynamic approach that favors active learning, encouraging students' autonomy and curiosity. For the teachers, the change observed is an improvement in the dynamism and enthusiasm to lead and interact with the students.

Learning is encouraged by the combination of different approaches: the involvement of the students in the setting up and the follow-up of the plants as well as the spectacular aspect of the presence of the multitude of species in the room at the same time allows to stimulate the interest for the subject, the playful aspect of the game used helps to acquire knowledge often prejudged boring (classifications, nomenclature...), and the search for information to answer the questions of the quiz is an effective way to help the students to use different sources of information and to find answers in an autonomous way.

Concerning the plant wall, the teachers' ambition is to create a second structure in order to keep a plant wall presenting the representative species of the major plant groups and to follow their development over several years (permanent exhibition), while the second structure would allow to work each year with the students for the implantation and the experimentation.

## Student feedback

> "Beyond the obvious fun aspect of learning in the form of a game, this practical work allowed the many students to visualize all the major plant families, to represent them with their main characteristics as well as the evolutionary relationships between them. To illustrate in a practical way the families seen during the rally, the room used for the practical work was completely transformed for the occasion. Numerous plants representing the main evolutionary axes and plant families were prepared especially for this exercise. They were arranged in an order following the evolutionary innovations and the students had to circulate between them in order to answer a questionnaire highlighting the key points to remember. The visual and sensory aspect of this method allowed the students to directly observe and compare, to make their own experience and hypotheses, guided by the questions.
> "The lab allowed us to discover plant diversity in a lively and entertaining way during our first year of biology at the University of Geneva: a large panel of plants selected in order to represent the diversity of each taxon described was presented (with the collaboration of the botanical garden of Geneva, rarely presented in 1st year biology), a quiz (linked to the exhibition) and a game allowed us a complete and affordable theoretical contribution for 1st year biology students, all this supervised by speakers.This was supervised by teachers and assistants who are specialists in a particular field of plant biology (Master's students at the botanical garden, basic research in plant biology).
