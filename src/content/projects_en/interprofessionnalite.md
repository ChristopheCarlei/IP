...
As the project is large-scale, the teaching team had to first ensure institutional support, which had to be backed by a strong political willingness to address a public health issue. To perpetuate such a project, it is also important to ensure that the content is updated to guarantee the quality of the training and to respond to national and international recommendations, to adapt to the new fields and to integrate the evolution of the competency referentials.

The success of the "Immersion in Interprofessionalism" conference is also due to the establishment of a competent team for both the pedagogical and logistical organization of such an event. For example, the team's roles and responsibilities include electronic communication with hundreds of students and dozens of speakers, the planning of dozens of teaching rooms and videoconference links, and the quality process for the evaluation of collaborative work and individual MCQs. To ensure a project of this scope, the CiS team had to be interprofessional. For this project, it mobilized nine members (secretary, assistant, techno-pedagogical assistant, lecturer, professor, institutional representatives and program managers), with complementary skills and an in-depth understanding of the care and learning contexts of the various training programs.

Despite the severe logistical constraints of integrating a common week into the respective academic calendars of all study streams, the CiS received several awards for the various interprofessional modules it implemented.

## Student feedback

> "This week covered topics outside of our training in each track and the contact with other students from other tracks was interesting. We also had to adapt to people we don't know and it created interprofessional work among us in addition to what we had to write about interprofessionally."
> "The workshops are varied and interesting, the interprofessional group work very rewarding."
> "Despite the health crisis, it was interesting to find a method to maintain this interprofessional week. I learned a lot and look forward to experimenting with this in my future internships."
> "Interesting and varied workshops and plenaries. + possibility to participate during the workshops - Very good organization - the rally was necessary for an introduction of each profession"
> "Interesting to work collaboratively."
> "This is a rich week. It reminds us of the importance of collaboration. It's good that it's not just a class."
> "The involvement of professionals from different professions - The e-learning courses were really great."
> "The opportunity to work already now with students from other majors - Having health care professionals talk to us about their daily lives and the things we will need to pay attention to in order to have a pleasant work climate and provide quality interdisciplinary care for patients."
> "The assignment to an IP group has greatly motivated me to be interested in other training tracks in healthcare and has taught me how to organize everyone's ideas in group work."
