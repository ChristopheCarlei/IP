...
The teacher drew attention to the selection of theoretical elements proposed during the oral presentations of articles. She became aware afterwards that those proposed this year sometimes overlapped with the themes that she addressed later in class. In addition, since students were encouraged to ask questions following the presentation, the time given to these questions was sometimes redundant with the theoretical explanations provided later.
On the other hand, after the first year, the teacher realized that limiting oral presentations to 20 minutes and 10 minutes for questions from peers did not quite fit the needs of the seminar. They are very time consuming as they often lead to informal discussions with the rest of the class. Therefore, it is necessary to allow 45 min for one presentation and several seminars for the whole.

## Student feedback

> "Interactive course, practical application of theoretical elements discussed during the course."
> "It's very practical, you really see how the methods are applied. It's not just theory, but every time we get an example of how mixed methods theories are applied in research."
> "Usefulness: this course can really help us in our further studies and research."
> "The plurality of teaching methods and the external speakers bring a lot to the dynamism of the course, plus the overall participation of the students is good which is very pleasant."
