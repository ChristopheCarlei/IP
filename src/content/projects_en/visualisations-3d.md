...
videos:
  - https://mediaserver.unige.ch/proxy/215784/VN5-5255-03-14.mp4?width=1280&height=720&start=0
---
...
Modeling and 3D animation have been specifically applied in this course to dentistry. The pedagogical approach can be extended to any anatomy course and more widely to other disciplines.

For this transfer, the most time-consuming part is the creation and animation of the 3D content. It is then necessary to be able to hold the class in a room equipped with 3D projectors (or screens) and 3D glasses. Alternatively, the use of virtual reality viewers (Google Cardboard or other inexpensive alternative) in combination with smartphones, if available, would be an alternative.
...
> The project was a huge success from the start. The students were instantly captivated by this novelty, and their attention was maintained throughout the course.
> The next success was seen in the practical work where the students had to carve a tooth in wax. The majority of the supervisors felt that this year's students did a very good job.

> ID 60 - Sociological film by Jenny Maggi [04/20]
> "[Strengths:] The interesting subject matter, a new methodology, viewing excerpts or films that I would not otherwise have the opportunity to see, freedoḿ from the exam format. The readings are often a good supplement."
