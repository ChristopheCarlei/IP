---
id: 145
title: Live reporting of Nicolas Szilas
...
From a logistical point of view, the reportage format course requires at least three members of the teaching team, in this case:

A cameraman to film the professional in the field and the teacher in interaction;

the teacher, who will structure the report by interviewing the professional;

the assistant, responsible for ensuring that the report is properly transmitted (sound and video quality) and for relaying students' questions to the professional.

In terms of equipment, on the day of the intervention, the team must bring a camera to film the professional in his or her environment. An iPhone and a stabilizer can be used. The course assistant takes a computer or tablet and logs on to Zoom to communicate with students and relay their questions. The teacher uses his/her laptop to deliver the concluding part of the course. It is necessary to ensure that the locations to which the team travels have either wifi or 3G access.

Live broadcasting via Zoom solves logistical problems such as space to accommodate the students, the fluidity of questions submitted to the professional or optimizing the angle of presentation of the digital object under study. Using the cell phone, the cameraman can zoom in on particular manipulations performed by the speaker. In this respect, it is strongly recommended that the teaching team setting up the course in reportage format ensure good broadcasting conditions (optimal wifi conditions, good sound feedback, good framing) so as not to diminish the commitment of the students. It is also advisable to get in touch with the professionals at least one month before the day of the event, to agree on the terms and conditions of the report, such as duration, speaking schedule, etc.

## Student feedback

> "I found it very interesting to have classes in report mode, I don't know if it helped my learning or not, but what is certain is that I was able to stay attentive from beginning to end because things move more and the interaction with the speaker is much more in the form of discussion."
> "Having external speakers was captivating and brought a lot to the learning. We remember information more easily than when we see it in a PPT without example."
> "The reportage format is interesting, but depending on camera angles or vision that shakes a bit, it can be more complicated to follow. There are also certain technical problems with cuts or extraneous noise from surrounding elements and people that prevent the information from being properly understood."
