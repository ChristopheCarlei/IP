...
The teacher noted a marked improvement in the interaction between the students and him during the course. The initial problem, which often saw him give a long monologue on the previous lesson, was transformed into a moment of debate and discussion where the students were led to argue their answer. In the end, this is what the teacher valued during the exam. Voting in class thus became a valuable tool for preparing for the exam.

To successfully engage students in peer-to-peer interaction, careful questioning and familiarity with "false friends," those decoy answers that resemble the correct answer and open the door to argument, are necessary. If you want to use voting to promote peer-to-peer learning, the use of these decoys or distracters is highly recommended for in-class polls or quizzes using Votamatic or any other online voting system.
