...
The teacher points out that such a course format requires a large investment of time for the 1ère occurrence of the course, but that this is offset by the time saved in subsequent years. However, it must be taken into account that continuous assessment also requires a certain amount of time.

## Student feedback

> "I appreciate the focus on learning given in the methodology of the course. I also found the homeworks very useful for my learning. However, I would have appreciated to have received their corresponding evaluation constantly during the course and not in the last week of the course. I consider it important to know the feedback in homework so I can improve in the following ones."
> "That it is very interactive and that we are working together to acquire the knowledge. Also the homeworks are effective as we have to read interesting papers and work on them."
> "Everyone actively participates during the course which allows us to find the economic insights on our own and really understand in detail each model."
